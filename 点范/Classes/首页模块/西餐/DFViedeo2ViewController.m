...
@interface DFViedeo2ViewController (){
}
...
@implementation DFViedeo2ViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    // Do any additional setup after loading the view.
    UIButton *vedioBtn = [UIButton buttonWithType:UIButtonTypeCustom];
    vedioBtn.frame = CGRectMake(0, 0, 100, 30);
    vedioBtn.backgroundColor = MainColor;
    vedioBtn.df_centerX = self.view.df_centerX;
    vedioBtn.df_y = self.view.df_height - 30;
    [vedioBtn addTarget:self action:@selector(takeButtonClick:) forControlEvents:UIControlEventTouchUpInside];
...
-(void)didRotateFromInterfaceOrientation:(UIInterfaceOrientation)fromInterfaceOrientation{
    _captureVideoPreviewLayer.frame=self.userCamera.bounds;
}
...
-(void)addGenstureRecognizer{
    ...
    [self.userCamera addGestureRecognizer:tapGesture];
}
-(void)tapScreen:(UITapGestureRecognizer *)tapGesture{
    CGPoint point= [tapGesture locationInView:self.userCamera];
    //将UI坐标转化为摄像头坐标

...
- (instancetype)initWithFrame:(CGRect)frame{
    if (self = [super initWithFrame:frame]) {
        ...
        [leftLabel setText:@"日   月   周" andFont:14 andColor:[UIColor whiteColor]];
        [self addSubview:leftLabel];
        
        //数字标题
        AMAnimatedNumber *numLabel =  [[AMAnimatedNumber alloc]initWithFrame:CGRectMake(20, 50, 150, 35)];
        ...
        [timeLabel setText:@"2016-6-13" andFont:14 andColor:[UIColor whiteColor]];
        timeLabel.textAlignment = NSTextAlignmentRight;
        [self addSubview:timeLabel];
    
        //分享文本
        AMAnimatedNumber *shareLabel =  [[AMAnimatedNumber alloc]initWithFrame:CGRectMake(0, 50, 120, 35)];

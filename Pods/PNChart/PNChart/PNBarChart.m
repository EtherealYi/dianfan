        ...
        for (int index = 0; index < _xLabels.count; index++) {
            ...
            if (labelAddCount == _xLabelSkip) {
                ...
                if (_rotateForXAxisText){
                    ...
                    labelXPosition = (index *  _xLabelWidth + _chartMarginLeft + _xLabelWidth /1.2);
                    
                }
                else{
                    if (_chartMarginLeft == 30) {
                ...
                label.center = CGPointMake(labelXPosition - _barMargin ,
                                           self.frame.size.height - kXLabelHeight - _chartMarginTop + label.frame.size.height /2.0 + _labelMarginTop + 20 + 5);
                labelAddCount = 0;
